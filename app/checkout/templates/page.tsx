                    ...
                    {availableTemplates.map((tmpl) => {
                        ...
                        return (
                            <div key={tmpl.id} className={`group relative bg-white/60 backdrop-blur-md border rounded-3xl overflow-hidden shadow-xl flex flex-col transition-all ${isComingSoon
                                ...
                                {/* Template Thumbnail — portrait phone ratio */}
                                <div className="w-full bg-slate-900 relative overflow-hidden flex items-center justify-center" style={{ aspectRatio: '9/18' }}>
                                    {tmpl.thumbnailUrl ? (
