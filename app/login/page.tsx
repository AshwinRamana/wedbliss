...
export default function LoginPage() {
    ...
    // Helper to handle OTP 4-digit pasting or typing
                    ...
                    <div className="relative z-10 bg-white/70 backdrop-blur-xl border border-emerald-900/10 rounded-3xl p-8 sm:p-10 shadow-2xl shadow-emerald-900/5">
                        <div className="text-center mb-8">
                            ...
                            <p className="text-slate-500 text-sm">
                                {step === "email" ? "Enter your email to sign in to WedBliss" : `We sent a code to ${email}`}
                            </p>
                        </div>
                        ...
                        {step === "email" ? (
                            ...
                            >
                                ...
                                <button disabled={loading} type="submit" className="mt-2 w-full py-3.5 bg-gradient-to-r from-emerald-600 to-emerald-500 text-white font-bold rounded-xl shadow-[0_4px_14px_rgba(4,120,87,0.3)] hover:-translate-y-0.5 transition-all disabled:opacity-50 disabled:hover:translate-y-0">
                                    ...
                                    <div className="flex gap-3 justify-between">
                                        {[0, 1, 2, 3].map((index) => (
                                            <input
                                                ...
                                                id={`otp-${index}`}
                                                type="text"
                                                maxLength={4} // Allow longer for paste catching
                                                value={otp[index]}
